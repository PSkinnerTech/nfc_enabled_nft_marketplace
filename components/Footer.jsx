  ...
  return (
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        <div className="flexStart flex-1 flex-col">
          ...
          <div className="flexBetween md:w-full minlg:w-557 w-357 mt-6 dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-nft-gray-2 rounded-md">
            <input
              ...
              className="h-full flex-1 w-full dark:bg-nft-black-2 bg-white px-4 rounded0-md dark:text-white text-nft-black-1 font-normall text-xs minlg:text-lg outline-none"
            />
        ...
        <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml0 md:mt-8">
          <FooterLinks
            heading="SHOP LYNx"
